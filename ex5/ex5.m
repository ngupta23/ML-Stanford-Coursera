...
% Commenting out since slow to load
% % Plot training data
...
%  "best" lambda value.
%
% Note that the validation curve has been modofied by Nikhil to also include
% the test error. This helps to validate the value of Lambda chosen
% but breaks the submit function due to extra arguments.
%
